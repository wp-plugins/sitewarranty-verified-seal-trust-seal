		...
		foreach ($meta_box['sw_field'] as $field) {
			...
			if($field['name']=='Style')
			{
				...
				echo '<table class="func_table">';
					echo '<tr>';
						echo '<td>';
							echo "<img src = ".plugins_url( '/sitewarranty-verified-seal-trust-seal/img/wordpress-seal-a.png').">";
							echo '<input type="radio" value="a" name="', $field['id'], '" id="', $field['id'], '"', ($meta=='a') ? ' checked="checked"' : '', ' />';
						echo '</td>';
						echo '<td>';
							echo "<img src = ".plugins_url( '/sitewarranty-verified-seal-trust-seal/img/wordpress-seal-b.png').">";
							echo '<input type="radio" value="b" name="', $field['id'], '" id="', $field['id'], '"', ($meta=='b') ? ' checked="checked"' : '', ' />';
						echo '</td>';
					echo '</tr>';
					echo '<tr>';
						echo '<td>';
							echo "<img src = ".plugins_url( '/sitewarranty-verified-seal-trust-seal/img/wordpress-seal-c.png').">";
							echo '<input type="radio" value="c" name="', $field['id'], '" id="', $field['id'], '"', ($meta=='c') ? ' checked="checked"' : '', ' />';
						echo '</td>';
						echo '<td>';
							echo "<img src = ".plugins_url( '/sitewarranty-verified-seal-trust-seal/img/wordpress-seal-d.png').">";
